package com.shuham.spring_boot_crash_course.security
...
class JwtService(
    ...
    private val accessTokenValidity = 15 * 60 * 1000L
    public val refreshTokenValidity = 30 * 24 * 60 * 60 * 1000L
    ...
    fun getUserIdFromToken(token: String): String {
        val rawToken = if(token.startsWith("Bearer")) token.substring("Bearer".length) else token
